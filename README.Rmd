...
[![Codecov test coverage](https://codecov.io/gh/SpatialPlanning/shinyplanr/graph/badge.svg)](https://app.codecov.io/gh/SpatialPlanning/shinyplanr)
<!-- badges: end -->
...
Everett JD, Richardson AJ, Neubert S, Dunn DC (2025). *shinyplanr: Spatial Planning in Shiny*. R package version 0.1.5. <https://github.com/SpatialPlanning/shinyplanr>
