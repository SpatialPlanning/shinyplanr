# Introduction to Spatial Planning {#sec-introduction}
...
[IMAGE: Example of planning units showing a hexagonal grid over a marine region]
...
The following chapters explain how to use *shinyplanr* to explore spatial planning scenarios and how to set up *shinyplanr* for new regions.
