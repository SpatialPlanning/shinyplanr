<img src="www/logo3.png" style="width:100%">
<br>
<br>
...
Welcome to our interactive visualisation tool for marine spatial planning. This tool is an instrumental part of the [Blue Prosperity Vanuatu (BPV)](https://www.blueprosperityvanuatu.org), a government-led program to support the sustainable growth of marine resources in Vanuatu.

The aim of this tool is to allow you to explore, discuss and identify potential spatial planning scenarios within Vanuatu. BPV aims to implement a holistic approach to spatial planning based on best available science and stakeholder participation to build a healthier marine environment that will benefit future generations.

We hope that this will aid those discussions towards transparent and scientific evidence-based spatial planning. The tool uses spatial layers of scientific evidence to help identify those areas that are relevant to one or more of your objectives. The layers have been created from a range of observational data and models.
...
We hope that this tool will aid discussions amongst stakeholders, providing a transparent and scientific evidence-based platform for development of the Vanuatu MSP.   
